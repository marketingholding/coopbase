...
function Index() {
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <header className="sticky top-0 z-40 backdrop-blur-xl bg-background/80 border-b border-border/40">
        <div className="max-w-[1024px] mx-auto px-6 h-12 flex items-center justify-between">
          <a href="#top" className="flex items-center">
            <img src={logo} alt="COOPBASE" className="h-5 w-auto" />
          </a>
          <nav className="hidden sm:flex items-center gap-8 text-[13px] text-foreground/80">
      ...
      <section id="comparar" className="bg-muted/40 py-24 sm:py-32 md:py-40">
        <div className="max-w-[1024px] mx-auto px-6">
          <div className="text-center mb-12 sm:mb-16">
            <SectionEyebrow label="Comparar" />
            <h2 className="text-3xl sm:text-5xl md:text-[56px] font-semibold tracking-[-0.04em] leading-[1.05] mb-5">
              Compare os planos.
            </h2>
            <p className="text-lg sm:text-xl text-muted-foreground leading-[1.4] max-w-xl mx-auto">
              O que está incluso em cada plano recorrente, lado a lado.
            </p>
          </div>
              ...
              <table className="w-full min-w-[640px] border-collapse text-left">
                <thead>
                  <tr className="border-b border-border/60">
                    <th className="py-5 sm:py-6 pl-6 pr-4 text-[13px] font-medium text-muted-foreground">
                      Recursos
                    </th>
                    <th className="py-5 sm:py-6 px-4 text-center">
                      <div className="text-[15px] font-semibold">Essencial</div>
                      <div className="text-xs text-muted-foreground mt-1">
                        R$ 4.000/mês
                      </div>
                    </th>
                    <th className="py-5 sm:py-6 px-4 text-center bg-primary/[0.04]">
                    ...
                    <th className="py-5 sm:py-6 px-4 pr-6 text-center">
                ...
                <tbody className="text-[14px]">
                  {[
                    ...
                    >
                      <td className="py-4 pl-6 pr-4 text-foreground/90">
                        {row.feature}
                      </td>
