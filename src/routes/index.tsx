...
const structuringProjects: Plan[] = [
  ...
  },
  {
    ...
    price: "R$ 10.000",
    objective:
      "Projeto de implantação e acompanhamento por 90 dias para mapear gargalos e redesenhar fluxos comerciais e técnicos.",
    features: [
  ...
  },
  {
    ...
    features: [
      "90 dias de acompanhamento com encontros semanais.",
